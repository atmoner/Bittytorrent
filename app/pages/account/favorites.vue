  ...
  <div class="min-h-screen py-8 px-4">
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Favoris</h1>
        <p class="text-gray-600">
          Cette page regroupe vos torrents favoris et vos contenus suivis.
        </p>
        <div class="mt-6">
...
<script setup lang="ts">
  ...
  type AccountFavoritesPageBlock = {
    id: string
    component?: string
  ...
  const pageBlocks = ref<AccountFavoritesPageBlock[]>([])
  ...
  const registerBlock = (block: AccountFavoritesPageBlock) => {
  ...
  onMounted(async () => {
    ...
    pageBlocks.value = []
    await executeHook("page:account-favorites", {
