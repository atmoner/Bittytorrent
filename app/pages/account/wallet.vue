  ...
  <div class="min-h-screen py-8 px-4">
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Wallet</h1>
        <p class="text-gray-600">
          Gérez ici votre solde et les informations liées à votre wallet.
        </p>
        <div class="mt-6">
...
<script setup lang="ts">
  ...
  const pageBlocks = ref<AccountWalletPageBlock[]>([])
  ...
  const registerBlock = (block: AccountWalletPageBlock) => {
  ...
  onMounted(async () => {
    ...
    pageBlocks.value = []
    await executeHook("page:account-wallet", {
      page: "account-wallet",
